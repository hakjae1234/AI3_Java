...
public class Main {
	...
	public static void main(String[] args) {
		...
		//student3.name = "고건우";
		//student3.age = 22;
		//student3.major = "컴퓨터공학과";
		//student3.stdNo = "20250001";
		...
		student3.study( "축구" );
		System.out.println("학생1 - 중간고사 점수 : " + student3.getAverage(100, 90));
		System.out.println("학생1 - 기말고사 점수 : " + student3.getAverage(100, 90, 70));
